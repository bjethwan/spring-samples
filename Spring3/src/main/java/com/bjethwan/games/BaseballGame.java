...
public class BaseballGame implements Game{
	...
	public void playNationalAnthem(){
		System.out.println("Playing independce day song");
	}
	...
	public void publishResutls(){
		System.out.println("Publishing results to natioanl records");
	}
